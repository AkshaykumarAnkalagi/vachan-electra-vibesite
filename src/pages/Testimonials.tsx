...
const statsData = [
  ...
  { label: 'Dealer Network', value: '150+' },
  { label: 'Cities Covered', value: '50+' },
  { label: 'KM Traveled', value: '15M+' }
];
    ...
    <PageLayout>
      ...
      <section className="relative min-h-[50vh] flex items-center bg-gray-900 text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1615729947596-a598e5de0ab3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              What Our <span className="text-electricLime">Users Say</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Real stories from drivers, dealers and fleet owners who have experienced the Vachan advantage.
            </p>
          </div>
        </div>
      </section>
