...
const serviceCentersData: CityData[] = [
  {
    ...
    centers: [
      {
        id: 1,
        name: 'Vachan Delhi Central',
        address: '123 Connaught Place, New Delhi, 110001',
        phone: '+91 11 4567 8901',
        email: 'delhi.central@vachanmotors.com',
      ...
      },
      {
        ...
        email: 'delhi.south@vachanmotors.com',
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            We offer comprehensive service and support for all Vachan Motors vehicles.
          </p>
            ...
            {[
              {
                ...
                description: 'Scheduled servicing to keep your vehicle in optimal condition.',
                icon: '🔧'
              },
              {
                title: 'Battery Service',
                description: 'Battery health checks, replacement, and optimization.',
                icon: '🔋'
              },
              {
                title: 'Repairs & Parts',
                description: 'Quick repairs with genuine Vachan Motors spare parts.',
                icon: '🛠️'
              },
              {
