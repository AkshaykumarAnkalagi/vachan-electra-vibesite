...
const testimonials: TestimonialType[] = [
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80',
    type: 'customer'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80',
    type: 'customer'
  },
  {
    id: 5,
    ...
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80',
    type: 'dealer'
  }
];
...
const TestimonialBar = () => {
  ...
  const scrollToTestimonial = (index: number) => {
    ...
    if (scrollRef.current) {
      ...
      const scrollPosition = index * (containerWidth / (isMobile ? 1 : 3));
  ...
  return (
    <div className="relative bg-gradient-to-r from-jetBlack to-gray-900 py-12 overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-3">
            <Button 
              ...
              variant="outline" 
              size="icon"
              className="rounded-full border-gray-600 text-gray-300 hover:text-white hover:border-electricLime"
            >
              <ArrowLeft size={18} />
            </Button>
            <Button 
        ...
        <div 
          ref={scrollRef}
          className="flex overflow-x-auto scrollbar-hide snap-x snap-mandatory space-x-6"
        >
          {testimonials.map((testimonial) => (
            <div 
              key={testimonial.id}
              className="min-w-[320px] md:min-w-[calc(33.333%-1rem)] flex-shrink-0 snap-start"
            >
